...
# DOCKER_IMAGE_TAG="example_algorithm_preliminary-docker-evaluation-sanity-check1"
# CONTAINER_NAME="example_algorithm_preliminary-docker-evaluation-sanity-check_container1"
DOCKER_IMAGE_TAG="docker-evaluation-sanity-checks"
CONTAINER_NAME="docker-evaluation-sanity-check_containers"
